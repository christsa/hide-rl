...
def design_agent_and_env(FLAGS):
    ...
    FLAGS.time_scale = 50    # Enter max sequence length in which each policy will specialize
    ...
    env = EnvironmentAdapter("fetch", "push", "Empty", project_state_to_end_goal, project_state_to_subgoal, FLAGS.show, normalization_dict, featurize_image=FLAGS.featurize_image, seed=FLAGS.seed)
