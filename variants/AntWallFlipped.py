...
def design_agent_and_env(FLAGS):
    ...
    env = EnvironmentAdapter("maze", "Ant", "WallTestFlippedDict", project_state_to_end_goal, project_state_to_subgoal, FLAGS.show, featurize_image=FLAGS.featurize_image)
