...
def design_agent_and_env(FLAGS):
    ...
    env = EnvironmentAdapter("maze", "Humanoid", "MazeDict", project_state_to_end_goal, project_state_to_subgoal, FLAGS.show, normalization_dict, featurize_image=FLAGS.featurize_image, seed=FLAGS.seed)
    ...
    agent_params["atomic_noise"] = [0.1 for i in range(17)]
