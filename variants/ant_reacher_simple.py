...
def design_agent_and_env(FLAGS):
    ...
    env = EnvironmentAdapter("HAC", "Ant", "ant_reacher_simple", project_state_to_end_goal, project_state_to_subgoal, FLAGS.show, normalization_dict)
    ...
    agent_params["subgoal_noise"] = [0.1 for i in range(len(env.subgoal_thresholds))]
