...
def design_agent_and_env(FLAGS):
    ...
    env = EnvironmentAdapter("maze", "Ant", "CustomDict", project_state_to_end_goal, project_state_to_subgoal, FLAGS.show, normalization_dict, featurize_image=FLAGS.featurize_image, seed=FLAGS.seed)
